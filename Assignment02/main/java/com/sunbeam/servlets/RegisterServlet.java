    ...
    private void processRequest(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try (UserDao userDao = new UserDaoImpl()) {
            ...
            if (result == 0) {
                ...
                out.println("<style>body { font-family: Arial, sans-serif; background-color: #f8f9fa; }</style>");
                out.println("</head>");
                out.println("<body>");
                ...
                out.println("<title>Voting Application</title>");
                out.println("<style>");
                out.println("body { font-family: Arial, sans-serif; background-color: #e9ecef; text-align: center; }");
